...
function Home() {
    return (
        <div class="mx-auto max-w-7xl px-4 py-10 sm:px-6 sm:py-10 lg:px-8">
            <h2 class="mb-1 text-2xl tracking-tight text-gray-900">Employee Details</h2>
            <form>
                <div class="space-y-12">
                    <div class="border-b border-gray-900/10 pb-12">
                        <h2 class="mb-10 text-base/7 font-semibold text-gray-900">Personal Information</h2>
            ...
            <div class="mt-10 relative overflow-x-auto">
                <h2 class="mb-10 text-2xl tracking-tight text-gray-900">Employee List</h2>
